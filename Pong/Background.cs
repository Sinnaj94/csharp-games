...
namespace Pong
{
    class Background : Drawable
    {
        ...
        Sprite backGroundSprite = new Sprite(new Texture(@"Resources/background.jpg"), new IntRect(0, 0, (int)(1366), (int)(768)));
        Sprite foreGroundSprite = new Sprite(new Texture(@"Resources/field.jpg"), new IntRect(0, 0, (int)(1366), (int)(768)));



        public Background(Vector2f windowSize)
        {
            backGroundSprite = new Sprite(new Texture(@"Resources/background.jpg"), new IntRect(0, 0, (int)(windowSize.X), (int)(windowSize.Y)));
            Console.Out.Write("" + backGroundSprite.Texture.Size.X);
